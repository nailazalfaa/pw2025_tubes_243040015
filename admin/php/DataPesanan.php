...
<?php $data_pelanggan = select ("SELECT * FROM data_pesanan");?>
<!DOCTYPE html>
<html lang="id">
<head>
  <meta charset="UTF-8">
  ...
  <div class="d-flex">
    ...
    <nav class="sidebar d-flex flex-column p-3">
      <a class="navbar-brand mb-4 fs-4 fw-bold text-white" href="#">
        ...
        <li><a href="DataMenu.php" class="nav-link"><i class="bi bi-list-ul me-2"></i>Data Menu</a></li>
        <li><a href="DataPesanan.php" class="nav-link active"><i class="bi bi-basket me-2"></i>Data Pesanan</a></li>
      </ul>
    </nav>
    ...
    <div class="flex-grow-1 d-flex flex-column min-vh-100">
            ...
            <ul class="dropdown-menu dropdown-menu-end">
              ...
              <li>
                <form method="POST" class="d-inline">
                  <button type="submit" name="pesanan" class="dropdown-item">Logout</button>
                </form>
              </li>
            </ul>
          </div>
      ...
      <div class="container py-4">
        <h3 class="mb-4 fw-bold">Daftar Pesanan</h3>
