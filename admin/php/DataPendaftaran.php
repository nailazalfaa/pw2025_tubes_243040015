...
<?php $data_pelanggan = select ("SELECT * FROM data_pendaftaran");?>
  ...
  <div class="d-flex">
    ...
    <nav class="sidebar d-flex flex-column p-3">
      ...
      <ul class="nav nav-pills flex-column mb-auto">
        <li class="nav-item">
          <a href="DataPendaftaran.php" class="nav-link active"><i class="bi bi-house-door me-2"></i>Data Pendaftaran</a>
        </li>
    ...
    <div class="flex-grow-1 d-flex flex-column min-vh-100">
      ...
      <div class="container py-4">
        <h3 class="mb-4 fw-bold">Daftar Pendaftaran</h3>
